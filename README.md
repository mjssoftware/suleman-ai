...
- 🌐 **Multi-language** - English, Arabic, Urdu, Indonesian support
- 🎨 **Modern UI** - Beautiful Islamic-themed interface with dark mode
- 📱 **Responsive** - Works on desktop, tablet, and mobile
- 🔒 **Secure** - Rate limiting, input sanitization, authentication ready
...
```bash
git clone https://github.com/mjssoftware/suleman-ai.git
cd suleman-ai